...
public class LibraryResource {
    ...
    public String getJson(@PathParam("id") String id) {
        ...
        List<BibEntryDTO> list =
                parserResult.getDatabase().getEntries().stream()
                        .peek(
                                bibEntry ->
    ...
    public String getClsItemJson(@PathParam("id") String id) {
        ...
        jabRefItemDataProvider.setData(
                parserResult.getDatabaseContext(), new BibEntryTypesManager());
    ...
    private java.nio.file.Path getLibraryPath(String id) {
        return preferences.getLastFilesOpenedPreferences().getLastFilesOpened().stream()
                .filter(
                        p ->
