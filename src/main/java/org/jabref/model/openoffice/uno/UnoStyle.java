...
public class UnoStyle {
    ...
    private static Optional<XStyle> getStyleFromFamily(XTextDocument doc, String familyName, String styleName)
        ...
        XStyleFamiliesSupplier fss =
                UnoCast.cast(XStyleFamiliesSupplier.class, doc).get();
        XNameAccess families =
                UnoCast.cast(XNameAccess.class, fss.getStyleFamilies()).get();
        XNameContainer xFamily;
        try {
            xFamily = UnoCast.cast(XNameContainer.class, families.getByName(familyName))
                    .get();
    ...
    public static Optional<String> getInternalNameOfStyle(XTextDocument doc, String familyName, String name)
            throws WrappedTargetException {
