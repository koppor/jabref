...
public class SystematicLiteratureReviewStudyEntryTypeDefinitions {
     ...
     * </ul>
     */
    private static final BibEntryType STUDY_ENTRY =
     ...
     * </ul>
     */
    private static final BibEntryType LIBRARY_ENTRY =
            new BibEntryTypeBuilder()
                    .withType(SystematicLiteratureReviewStudyEntryType.STUDY_ENTRY)
    ...
    public static final List<BibEntryType> ALL =
            Arrays.asList(STUDY_ENTRY, SEARCH_QUERY_ENTRY, LIBRARY_ENTRY);
