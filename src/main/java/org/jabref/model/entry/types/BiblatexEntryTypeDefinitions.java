...
public class BiblatexEntryTypeDefinitions {
    ...
    private static final BibEntryType BOOKLET = new BibEntryTypeBuilder()
            ...
            .withImportantFields(
                    ...
                    StandardField.URLDATE)
            .withRequiredFields(
                    new OrFields(StandardField.AUTHOR, StandardField.EDITOR), StandardField.TITLE, StandardField.DATE)
            .withDetailFields(
                    StandardField.SUBTITLE,
                    StandardField.TITLEADDON,
                    StandardField.LANGUAGE,
    ...
    private static final BibEntryType MASTERSTHESIS = new BibEntryTypeBuilder()
            ...
            .withImportantFields(
                    ...
                    StandardField.URLDATE)
            .withRequiredFields(
                    StandardField.AUTHOR, StandardField.TITLE, StandardField.INSTITUTION, StandardField.DATE)
            .withDetailFields(
                    StandardField.TYPE,
                    StandardField.SUBTITLE,
                    StandardField.TITLEADDON,
