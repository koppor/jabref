...
public class BiblatexEntryTypeDefinitions {
    ...
    private static final BibEntryType ARTICLE =
    ...
    private static final BibEntryType BOOK =
            new BibEntryTypeBuilder()
                    .withType(StandardEntryType.Book)
                    .withRequiredFields(
                            StandardField.AUTHOR, StandardField.TITLE, StandardField.DATE)
                    .withImportantFields(
                            StandardField.EDITOR,
                            StandardField.SUBTITLE,
                            StandardField.TITLEADDON,
    ...
    private static final BibEntryType MVBOOK =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType INBOOK =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType BOOKINBOOK =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType SUPPBOOK =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType BOOKLET =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType COLLECTION =
            new BibEntryTypeBuilder()
                    .withType(StandardEntryType.Collection)
                    .withRequiredFields(
                            StandardField.EDITOR, StandardField.TITLE, StandardField.DATE)
                    .withImportantFields(
                            StandardField.TRANSLATOR,
                            StandardField.SUBTITLE,
                            StandardField.TITLEADDON,
    ...
    private static final BibEntryType MVCOLLECTION =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType INCOLLECTION =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType SUPPCOLLECTION =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType MANUAL =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType MISC =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType ONLINE =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType PATENT =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType PERIODICAL =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType SUPPPERIODICAL =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType PROCEEDINGS =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType MVPROCEEDINGS =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType INPROCEEDINGS =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType REFERENCE =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType MVREFERENCE =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType INREFERENCE =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType REPORT =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType UNPUBLISHED =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType CONFERENCE =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType ELECTRONIC =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType MASTERSTHESIS =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType PHDTHESIS =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType TECHREPORT =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType WWW =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType SOFTWARE =
            new BibEntryTypeBuilder()
    ...
    private static final BibEntryType DATASET =
            new BibEntryTypeBuilder()
    ...
    public static final List<BibEntryType> RECOMMENDED =
            Arrays.asList(ARTICLE, BOOK, INPROCEEDINGS, REPORT, MISC);
}
