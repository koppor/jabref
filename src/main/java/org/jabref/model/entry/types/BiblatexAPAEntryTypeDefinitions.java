...
public class BiblatexAPAEntryTypeDefinitions {
    ...
    private static final BibEntryType JURISDICTION =
            new BibEntryTypeBuilder()
                    .withType(BiblatexApaEntryType.Jurisdiction)
                    .withImportantFields(
                            StandardField.ORGANIZATION,
                            BiblatexApaField.CITATION_CITEORG,
                            BiblatexApaField.CITATION_CITEDATE,
                            BiblatexApaField.CITATION_CITEDATE,
                            StandardField.ORIGDATE)
                    .withRequiredFields(
                            StandardField.TITLE,
                            BiblatexApaField.CITATION,
                            BiblatexApaField.CITATION_CITEINFO,
                            StandardField.URL,
                            StandardField.DATE)
                    .build();

    private static final BibEntryType LEGISLATION =
            new BibEntryTypeBuilder()
    ...
    public static final List<BibEntryType> ALL =
            Arrays.asList(JURISDICTION, LEGISLATION, LEGADMINMATERIAL, CONSTITUTION, LEGAL);
}
