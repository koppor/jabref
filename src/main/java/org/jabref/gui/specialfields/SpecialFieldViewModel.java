...
public class SpecialFieldViewModel {
    ...
    public SpecialFieldViewModel(
            SpecialField field, CliPreferences preferences, UndoManager undoManager) {
    ...
    public SpecialFieldAction getSpecialFieldAction(
        ...
        return new SpecialFieldAction(
                ...
                // if field contains only one value, it has to be nulled, as another setting does
                // not empty the field
