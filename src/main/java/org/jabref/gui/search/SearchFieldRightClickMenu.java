...
public class SearchFieldRightClickMenu {
    ...
    public static Menu createSearchFromHistorySubMenu(
            StateManager stateManager, CustomTextField searchField) {
        ActionFactory factory = new ActionFactory();
        Menu searchFromHistorySubMenu =
                factory.createMenu(() -> Localization.lang("Search from history..."));
        ...
        if (searchHistory.isEmpty()) {
            ...
            MenuItem clear =
                    factory.createMenuItem(
                            () -> Localization.lang("Clear history"),
                            new SimpleCommand() {
                                @Override
                                public void execute() {
