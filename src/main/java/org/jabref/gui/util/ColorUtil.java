...
public class ColorUtil {
    ...
    public static String toHex(Color validFieldBackgroundColor) {
        return "#%02x%02x%02x"
                .formatted(
                        (int) validFieldBackgroundColor.getRed(),
                        (int) validFieldBackgroundColor.getGreen(),
                        (int) validFieldBackgroundColor.getBlue());
    }

    public static StringProperty createFlashingColorStringProperty(
    ...
    public static void setColorStringFromColor(
