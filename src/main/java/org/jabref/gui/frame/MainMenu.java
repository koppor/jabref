...
public class MainMenu extends MenuBar {
    ...
    private void createMenu() {
        ...
        file.getItems()
                .addAll(
                        factory.createMenuItem(
                                ...
                                new NewDatabaseAction(frame, preferences)),
                        factory.createMenuItem(
                                StandardActions.OPEN_LIBRARY, openDatabaseActionSupplier.get()),
                        fileHistoryMenu,
                        factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                ...
                                new SaveAllAction(
                                        frame::getLibraryTabs, preferences, dialogService)),
                        factory.createMenuItem(
                                StandardActions.CLOSE_LIBRARY,
                                new JabRefFrame.CloseDatabaseAction(frame, stateManager)),
                        ...
                        factory.createSubMenu(
                                ...
                                factory.createMenuItem(
                                        ...
                                        new ConnectToSharedDatabaseCommand(frame, dialogService)),
                                factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                ...
                                new ShowPreferencesAction(frame, dialogService)),
                        new SeparatorMenuItem(),
                        factory.createMenuItem(
                                StandardActions.QUIT, new JabRefFrame.CloseAction(frame)));
                ...
                .addAll(
                        ...
                        factory.createMenuItem(
                                ...
                                new ReplaceStringAction(
                                        frame::getCurrentLibraryTab, stateManager, dialogService)),
                        factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                ...
                                new AutomaticFieldEditorAction(
                                        stateManager, dialogService, undoManager)));
        SeparatorMenuItem specialFieldsSeparator = new SeparatorMenuItem();
        specialFieldsSeparator
                .visibleProperty()
                .bind(preferences.getSpecialFieldsPreferences().specialFieldsEnabledProperty());

        edit.getItems()
                .addAll(
                        specialFieldsSeparator,
                        // ToDo: SpecialField needs the active BasePanel to mark it as changed.
                        //  Refactor BasePanel, should mark the BibDatabaseContext or the
                        // UndoManager as dirty instead!
        ...
        edit.addEventHandler(
                ActionEvent.ACTION,
                event -> {
                    // Work around for mac only issue, where cmd+v on a dialogue triggers the paste
                    // action of menu item, resulting in addition of the pasted content in the
                    // MainTable.
        ...
        MenuItem newEntryFromPlainTextOnline =
                factory.createMenuItem(
                        StandardActions.NEW_ENTRY_FROM_PLAIN_TEXT_ONLINE,
                        new ExtractBibtexActionOnline(
                                dialogService, preferences, stateManager, true));
        library.getItems()
                .addAll(
                        factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                StandardActions.NEW_ENTRY_FROM_PLAIN_TEXT_OFFLINE,
                                new ExtractBibtexActionOffline(dialogService, stateManager)),
                        factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                ...
                                new LibraryPropertiesAction(stateManager)));
                ...
                .addAll(
                        ...
                        factory.createMenuItem(
                                ...
                                new MergeEntriesAction(
                                        dialogService, stateManager, undoManager, preferences)),
                        factory.createMenuItem(
        ...
        for (IdFetcher<?> fetcher :
                WebFetchers.getIdFetchers(preferences.getImportFormatPreferences())) {
            LookupIdentifierAction<?> identifierAction =
                    new LookupIdentifierAction<>(
                            fetcher, stateManager, undoManager, dialogService, taskExecutor);
            lookupIdentifiers
                    .getItems()
                    .add(factory.createMenuItem(identifierAction.getAction(), identifierAction));
        }
        ...
        final MenuItem pushToApplicationMenuItem =
                factory.createMenuItem(
                        pushToApplicationCommand.getAction(), pushToApplicationCommand);
        pushToApplicationCommand.registerReconfigurable(pushToApplicationMenuItem);

        tools.getItems()
                .addAll(
                        factory.createMenuItem(
                                StandardActions.PARSE_LATEX, new ParseLatexAction(stateManager)),
                        factory.createMenuItem(
                                StandardActions.NEW_SUB_LIBRARY_FROM_AUX,
                                new NewSubLibraryAction(frame, stateManager, dialogService)),
                        factory.createMenuItem(
                                StandardActions.NEW_LIBRARY_FROM_PDF_ONLINE,
                                new NewLibraryFromPdfActionOnline(
                                        frame,
                                        stateManager,
                                        dialogService,
                                        preferences,
                                        taskExecutor)),
                        factory.createMenuItem(
                                StandardActions.NEW_LIBRARY_FROM_PDF_OFFLINE,
                                new NewLibraryFromPdfActionOffline(
                                        frame,
                                        stateManager,
                                        dialogService,
                                        preferences,
                        ...
                        factory.createMenuItem(
                                ...
                                new RebuildFulltextSearchIndexAction(
                                        ...
                                        preferences)),
                        factory.createMenuItem(
                                StandardActions.CLEAR_EMBEDDINGS_CACHE,
                                new ClearEmbeddingsAction(
                                        stateManager, dialogService, aiService, taskExecutor)),
                        new SeparatorMenuItem(),
                        factory.createMenuItem(
                                StandardActions.REDOWNLOAD_MISSING_FILES,
                                new RedownloadMissingFilesAction(
                                        stateManager,
                                        dialogService,
        ...
        view.getItems()
                .addAll(
                        ...
                        factory.createMenuItem(
                                ...
                                new PreviewSwitchAction(
                                        PreviewSwitchAction.Direction.NEXT,
                                        frame::getCurrentLibraryTab,
                                        stateManager)),
                        factory.createMenuItem(
                                StandardActions.PREVIOUS_PREVIEW_STYLE,
                                new PreviewSwitchAction(
                                        PreviewSwitchAction.Direction.PREVIOUS,
                                        frame::getCurrentLibraryTab,
                                        stateManager)),
                        new SeparatorMenuItem(),
                        factory.createMenuItem(
                                StandardActions.SHOW_PDF_VIEWER,
                                new ShowDocumentViewerAction(stateManager, preferences)),
                        factory.createMenuItem(
                                StandardActions.EDIT_ENTRY,
                                new OpenEntryEditorAction(
                                        frame::getCurrentLibraryTab, stateManager)),
                        factory.createMenuItem(
                                StandardActions.OPEN_CONSOLE,
                                new OpenConsoleAction(stateManager, preferences, dialogService)));
        ...
        help.getItems()
                .addAll(
                        ...
                        new SeparatorMenuItem(),
                        factory.createMenuItem(
                                StandardActions.ERROR_CONSOLE, new ErrorConsoleAction()),
                        new SeparatorMenuItem(),
                        factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                ...
                                new SearchForUpdateAction(
                                        preferences, dialogService, taskExecutor)),
                        factory.createSubMenu(
                ...
                .addAll(
                        ...
                        factory.createMenuItem(
                                ...
                                new SendAsKindleEmailAction(
                                        dialogService, preferences, stateManager, taskExecutor)));
