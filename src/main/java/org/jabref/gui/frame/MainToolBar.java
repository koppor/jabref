...
public class MainToolBar extends ToolBar {
    ...
    private void createToolBar() {
        ...
        // Therefore, the condition of enablement is "only" if a library is opened. (Parameter
        // "false")
        Button newEntryFromPlainTextOnlineButton =
                factory.createIconButton(
                        StandardActions.NEW_ENTRY_FROM_PLAIN_TEXT,
                        new ExtractBibtexActionOnline(
                                dialogService, preferences, stateManager, false));
    ...
    Button createNewEntryFromIdButton() {
        ...
        newEntryFromIdButton.setOnMouseClicked(
                event -> {
        ...
        indicator
                ...
                .addListener(
                        (observable, oldValue, newValue) -> {
                            ...
                            // We must make sure they are the same width for the clipping to result
                            // in a square of the same size always.
                ...
                event -> {
                    ...
                    taskProgressSubscription =
                            EasyBind.bindContent(
                                    ...
                                    stateManager.getRunningBackgroundTasks());
                    taskProgressView.setRetainTasks(false);
                    taskProgressView.setGraphicFactory(
                            task ->
                                    ThemeManager.getDownloadIconTitleMap.getOrDefault(
                                            task.getTitle(), null));
