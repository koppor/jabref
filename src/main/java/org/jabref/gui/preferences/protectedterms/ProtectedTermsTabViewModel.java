...
public class ProtectedTermsTabViewModel implements PreferenceTabViewModel {
    ...
    public ProtectedTermsTabViewModel(
            ProtectedTermsLoader termsLoader, DialogService dialogService, PreferencesService preferencesService) {
    ...
    public void setValues() {
        ...
        termsFilesProperty.addAll(termsLoader.getProtectedTermsLists().stream()
    ...
    public void addFile() {
        ...
        dialogService.showFileOpenDialog(fileDialogConfiguration).ifPresent(file -> {
            ...
            termsFilesProperty.add(new ProtectedTermsListItemModel(
