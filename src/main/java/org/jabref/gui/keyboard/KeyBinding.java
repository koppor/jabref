...
public enum KeyBinding {
    ...
    EDITOR_WORD_FORWARD(
            "Move caret to next word", Localization.lang("Move caret to next word"), "", KeyBindingCategory.EDITOR),
    EDITOR_BEGINNING(
    ...
    COPY_CITATION_KEY(
            "Copy citation key", Localization.lang("Copy citation key"), "ctrl+shift+K", KeyBindingCategory.EDIT),
    ...
    EXPORT_SELECTED(
            "Export Selected", Localization.lang("Export selected entries"), "ctrl+shift+e", KeyBindingCategory.FILE),
    ...
    NEW_MASTERSTHESIS(
            "New mastersthesis", Localization.lang("New mastersthesis"), "ctrl+shift+M", KeyBindingCategory.BIBTEX),
    ...
    OPEN_CONSOLE(
            "Open terminal here", Localization.lang("Open terminal here"), "ctrl+shift+L", KeyBindingCategory.TOOLS),
    ...
    PREVIOUS_PREVIEW_LAYOUT(
            ...
            KeyBindingCategory.VIEW),
    PREVIOUS_LIBRARY(
            "Previous library", Localization.lang("Previous library"), "ctrl+PAGE_UP", KeyBindingCategory.VIEW),
    PUSH_TO_APPLICATION(
            "Push to application", Localization.lang("Push to application"), "ctrl+L", KeyBindingCategory.TOOLS),
    ...
    SAVE_DATABASE_AS(
            "Save library as ...", Localization.lang("Save library as..."), "ctrl+shift+S", KeyBindingCategory.FILE),
    ...
    STRING_DIALOG_REMOVE_STRING(
            ...
            KeyBindingCategory.FILE),
    SYNCHRONIZE_FILES(
            "Synchronize files", Localization.lang("Synchronize files"), "ctrl+shift+F7", KeyBindingCategory.QUALITY),
    TOGGLE_GROUPS_INTERFACE(
            "Toggle groups interface", Localization.lang("Toggle groups interface"), "alt+3", KeyBindingCategory.VIEW),
