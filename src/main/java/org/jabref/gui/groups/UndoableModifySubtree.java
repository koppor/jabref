...
public class UndoableModifySubtree extends AbstractUndoableJabRefEdit {
    ...
    public UndoableModifySubtree(
            GroupTreeNodeViewModel groupRoot, GroupTreeNodeViewModel subtree, String name) {
    ...
    public void undo() {
        ...
        // get node to edit
        final GroupTreeNode subtreeRoot =
                m_groupRoot.getDescendant(m_subtreeRootPath).get(); // TODO: NULL
