...
public class ThreeWayMergeHeaderView extends GridPane {
    ...
    public ThreeWayMergeHeaderView(String leftHeader, String rightHeader) {
        ...
        // The fields grid pane is contained within a scroll pane, thus it doesn't allocate the full
        // available width. In
        // fact, it uses the available width minus the size of the scrollbar which is 8. This leads
        // to header columns being
