...
public class ChangeScanner {
    ...
    public ChangeScanner(
            BibDatabaseContext database, DialogService dialogService, GuiPreferences preferences) {
        this.database = database;
        this.preferences = preferences;
        this.databaseChangeResolverFactory =
                new DatabaseChangeResolverFactory(dialogService, database, preferences);
    }
    ...
    public List<DatabaseChange> scanForChanges() {
        ...
        try {
            ...
            return DatabaseChangeList.compareAndGetChanges(
                    database, databaseOnDisk, databaseChangeResolverFactory);
        } catch (IOException e) {
