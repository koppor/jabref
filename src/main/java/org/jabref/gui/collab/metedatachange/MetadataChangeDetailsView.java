...
public final class MetadataChangeDetailsView extends DatabaseChangeDetailsView {
    ...
    public MetadataChangeDetailsView(
            MetadataChange metadataChange, GlobalCitationKeyPatterns globalCitationKeyPatterns) {
        ...
        for (MetaDataDiff.Difference diff :
                metadataChange.getMetaDataDiff().getDifferences(globalCitationKeyPatterns)) {
