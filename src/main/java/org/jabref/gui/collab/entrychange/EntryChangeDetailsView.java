...
public final class EntryChangeDetailsView extends DatabaseChangeDetailsView {
    ...
    public EntryChangeDetailsView(
        ...
        PreviewViewer previewClone =
                new PreviewViewer(
                        databaseContext, dialogService, preferences, themeManager, taskExecutor);
        ...
        EasyBind.subscribe(
                ...
                selectedIndex -> {
                    if (oldEntryTabPane.getSelectionModel().getSelectedIndex()
                    ...
                    if (!scrolling) {
                        ...
                        if (event instanceof MouseEvent mouseEvent) {
                            if (mouseEvent.isPrimaryButtonDown()) {
                                int value =
                                        (Integer)
                                                webView.getEngine().executeScript("window.scrollY");
                                otherWebView
                                        .getEngine()
