...
public class SearchShortScienceAction extends SimpleCommand {
    ...
    public SearchShortScienceAction(
            DialogService dialogService, StateManager stateManager, GuiPreferences preferences) {
        this.dialogService = dialogService;
        this.stateManager = stateManager;
        this.preferences = preferences;

        BooleanExpression fieldIsSet =
                isFieldSetForSelectedEntry(StandardField.TITLE, stateManager);
        ...
        stateManager
                ...
                .ifPresent(
                        databaseContext -> {
                            ...
                            ExternalLinkCreator.getShortScienceSearchURL(bibEntries.getFirst())
                                    .ifPresent(
                                            url -> {
                                                try {
