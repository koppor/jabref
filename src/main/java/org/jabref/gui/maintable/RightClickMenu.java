...
public class RightClickMenu {
    ...
    public static ContextMenu create(
        ...
        ExtractReferencesAction extractReferencesAction =
                new ExtractReferencesAction(dialogService, stateManager, preferences);
        // Two menu items required, because of menu item display. Action checks preference internal
        // what to do
        MenuItem extractFileReferencesOnline =
                factory.createMenuItem(
                        StandardActions.EXTRACT_FILE_REFERENCES_ONLINE, extractReferencesAction);
        MenuItem extractFileReferencesOffline =
                factory.createMenuItem(
                        StandardActions.EXTRACT_FILE_REFERENCES_OFFLINE, extractReferencesAction);
                ...
                .addAll(
                        ...
                        factory.createMenuItem(
                                ...
                                new OpenFolderAction(
                                        dialogService, stateManager, preferences, taskExecutor)),
                        factory.createMenuItem(
                        ...
                        factory.createMenuItem(
                                ...
                                new SearchShortScienceAction(
                                        dialogService, stateManager, preferences)),
                        new SeparatorMenuItem(),
