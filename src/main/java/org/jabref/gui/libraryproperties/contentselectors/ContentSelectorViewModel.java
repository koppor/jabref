...
public class ContentSelectorViewModel implements PropertiesTabViewModel {
    ...
    private static final List<Field> DEFAULT_FIELD_NAMES =
    ...
    public void setValues() {
        ...
        metaData.getContentSelectors()
                .getContentSelectors()
                .forEach(existingContentSelector -> fieldKeywordsMap.put(
                        existingContentSelector.getField(), new ArrayList<>(existingContentSelector.getValues())));
    ...
    public void storeSettings() {
        ...
        if (isDefaultMap(fieldKeywordsMap)) {
            Iterator<ContentSelector> iterator =
                    metaData.getContentSelectors().getContentSelectors().iterator();
    ...
    void showInputFieldNameDialog() {
        dialogService
                .showInputDialogAndWait(Localization.lang("Add new field name"), Localization.lang("Field name"))
    ...
    void showRemoveFieldNameConfirmationDialog(Field fieldToRemove) {
        ...
        boolean deleteConfirmed = dialogService.showConfirmationDialogAndWait(
                ...
                Localization.lang(
                        "Are you sure you want to remove field name: \"%0\"?", fieldToRemove.getDisplayName()));
    ...
    void showInputKeywordDialog(Field selectedField) {
        dialogService
                .showInputDialogAndWait(Localization.lang("Add new keyword"), Localization.lang("Keyword:"))
