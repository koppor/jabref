...
public enum StandardExternalFileType implements ExternalFileType {
    ...
    public String getOpenWithApplication() {
        // On all OSes there is a generic application available to handle file opening, so use this
        // one
        return "";
    }
