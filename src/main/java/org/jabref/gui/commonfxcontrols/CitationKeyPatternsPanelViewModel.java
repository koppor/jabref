...
public class CitationKeyPatternsPanelViewModel {
    ...
    public static Comparator<CitationKeyPatternsPanelItemModel> defaultOnTopComparator =
            (o1, o2) -> {
    ...
    private final ObjectProperty<CitationKeyPatternsPanelItemModel> defaultItemProperty =
    ...
    public void setValues(
            Collection<BibEntryType> entryTypeList, AbstractCitationKeyPatterns initialKeyPattern) {
        ...
        defaultItemProperty.setValue(
                new CitationKeyPatternsPanelItemModel(new DefaultEntryType(), defaultPattern));
        ...
        entryTypeList.stream()
                ...
                .forEach(
                        entryType -> {
                            ...
                            patternListProperty.add(
                                    new CitationKeyPatternsPanelItemModel(entryType, pattern));
                        });
    }
