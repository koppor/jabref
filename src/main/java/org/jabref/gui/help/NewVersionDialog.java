...
public class NewVersionDialog extends BaseDialog<Boolean> {
    ...
    public NewVersionDialog(
        ...
        ButtonType btnIgnoreUpdate =
                new ButtonType(
                        Localization.lang("Ignore this update"), ButtonBar.ButtonData.CANCEL_CLOSE);
        ButtonType btnDownloadUpdate =
                new ButtonType(Localization.lang("Download update"), ButtonBar.ButtonData.APPLY);
        ButtonType btnRemindMeLater =
                new ButtonType(
                        Localization.lang("Remind me later"), ButtonBar.ButtonData.CANCEL_CLOSE);
        this.getDialogPane()
                .getButtonTypes()
                .addAll(btnIgnoreUpdate, btnDownloadUpdate, btnRemindMeLater);
        ...
        Hyperlink lblMoreInformation =
                new Hyperlink(Localization.lang("To see what is new view the changelog."));
        lblMoreInformation.setOnAction(
                event ->
                        NativeDesktop.openBrowserShowPopup(
                                latestVersion.getChangelogUrl(),
                                dialogService,
                                externalApplicationsPreferences));
