...
public class CheckForNewEntryTypesAction implements GUIPostOpenAction {
    ...
    public boolean isActionNecessary(ParserResult parserResult, CliPreferences preferences) {
        return !getListOfUnknownAndUnequalCustomizations(
                        parserResult, preferences.getLibraryPreferences())
                .isEmpty();
    }
    ...
    public void performAction(
            ...
            CliPreferences preferencesService) {
        ...
        dialogService.showCustomDialogAndWait(
                new ImportCustomEntryTypesDialog(
                        mode, getListOfUnknownAndUnequalCustomizations(parserResult, preferences)));
    }

    private List<BibEntryType> getListOfUnknownAndUnequalCustomizations(
            ParserResult parserResult, LibraryPreferences preferences) {
        BibDatabaseMode mode = getBibDatabaseModeFromParserResult(parserResult, preferences);
