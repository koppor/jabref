                ...
                evt -> {
                    ...
                    if (result.isPresent()) {
                        ...
                        handler.importEntryWithDuplicateCheck(
                                libraryTab.getBibDatabaseContext(), entry);
                        ...
                        // When DOI ID is not found, allow the user to either return to the dialog
                        // or add entry manually
