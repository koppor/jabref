...
public class WriteMetadataToSinglePdfAction extends SimpleCommand {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(WriteMetadataToSinglePdfAction.class);
                        ...
                        () -> {
                            ...
                            if (file.isEmpty()) {
                                ...
                                try {
                                    ...
                                    dialogService.notify(
                                            Localization.lang(
                                                    "Success! Finished writing metadata."));
                                } catch (IOException | TransformerException ex) {
                                    dialogService.notify(
                                            Localization.lang(
                                                    "Error while writing metadata. See the error log for details."));
                                    LOGGER.error(
    ...
    public static synchronized void writeMetadataToFile(
            ...
            XmpPreferences xmpPreferences)
            throws Exception {
        // Similar code can be found at {@link
        // org.jabref.gui.exporter.WriteMetadataToPdfAction.writeMetadataToFile}
        ...
        EmbeddedBibFilePdfExporter embeddedBibExporter =
                new EmbeddedBibFilePdfExporter(
                        databaseContext.getMode(), bibEntryTypesManager, fieldPreferences);
