...
public class CliOptions {
    ...
    public String getWriteMetadataToPdf() {
        return commandLine.hasOption("writeMetadatatoPdf")
                ? commandLine.getOptionValue("writeMetadataToPdf")
                : commandLine.hasOption("writeXMPtoPdf")
                        ? commandLine.getOptionValue("writeXmpToPdf")
                        : commandLine.hasOption("embeddBibfileInPdf")
                                ? commandLine.getOptionValue("embeddBibfileInPdf")
                                : null;
    }
    ...
    public static void printUsage(CliPreferences preferences) {
        ...
        List<Pair<String, String>> importFormats =
        ...
        List<Pair<String, String>> exportFormats =
