...
public class BibStringChecker implements EntryChecker {
    ...
    // Detect FieldWriter.BIBTEX_STRING_START_END_SYMBOL (#) if it doesn't have a \ in front of it
    // or if it starts the string
    private static final Pattern UNESCAPED_HASH =
            Pattern.compile(
                    "(?<!\\\\)"
