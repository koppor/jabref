...
public class OS {
    ...
    public static String getHostName() {
        ...
        if (StringUtil.isBlank(hostName)) {
            try {
                ...
                LoggerFactory.getLogger(OS.class)
        ...
        if (Objects.equals(programName, "texworks")) {
            ...
            if (Files.exists(texworksLinkPath)) {
                try {
                    ...
                    logger.log(
                            Level.WARNING, "Had an error while reading .lnk file for TeXworks", e);
                }
            }
        }
    ...
    private static String getProgramPath(
            String programName, String directoryName, String progFiles) {
        Path programPath;
