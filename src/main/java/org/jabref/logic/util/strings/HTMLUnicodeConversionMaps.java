...
public class HTMLUnicodeConversionMaps {
    ...
    // The symbols can be seen at http://www.fileformat.info/info/unicode/char/a4/index.htm. Replace "a4" with the U+
    // number
    // http://detexify.kirelabs.org/classify.html and http://www.ctan.org/tex-archive/info/symbols/comprehensive/ might
    // help to find the right LaTeX command
    ...
    static {
        ...
        for (String[] anAccentList : ACCENT_LIST) {
            ...
            UNICODE_ESCAPED_ACCENTS.put(
                    anAccentList[1], String.valueOf(Character.toChars(Integer.decode(anAccentList[0]))));
        }
