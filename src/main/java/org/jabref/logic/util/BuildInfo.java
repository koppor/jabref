...
public final class BuildInfo {
    ...
    public BuildInfo(String path) {
        ...
        springerNatureAPIKey =
                BuildInfo.getValue(
                        properties, "springerNatureAPIKey", "118d90a519d0fc2a01ee9715400054d4");
        ...
        scienceDirectApiKey =
                BuildInfo.getValue(
                        properties, "scienceDirectApiKey", "fb82f2e692b3c72dafe5f4f1fa0ac00b");
    ...
    private static String getValue(Properties properties, String key, String defaultValue) {
        String result =
                Optional.ofNullable(properties.getProperty(key))
                        // workaround unprocessed build.properties file --> just remove the
                        // reference to some variable used in build.gradle
