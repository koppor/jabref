    ...
    public List<FieldChange> cleanup(BibEntry entry) {
        ...
        for (Field field :
                Arrays.asList(
                        ...
                        StandardField.NOTE,
                        StandardField.EID)) {
            Optional<ArXivIdentifier> arXivIdentifier =
                    entry.getField(field).flatMap(ArXivIdentifier::parse);
            ...
            if (arXivIdentifier.isPresent()) {
                ...
                entry.setField(StandardField.EPRINT, normalizedEprint).ifPresent(changes::add);
