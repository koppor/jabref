...
public class URLCleanup implements CleanupJob {
    ...
    private static final Pattern DATE_TERMS_PATTERN =
            Pattern.compile(DATE_TERMS_REGEX, Pattern.CASE_INSENSITIVE);
    private static final Pattern DATE_PATTERN =
            Pattern.compile(Date.DATE_REGEX, Pattern.CASE_INSENSITIVE);
