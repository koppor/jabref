...
public class CitationStyleGenerator {
     ...
     */
    protected static String generateBibliography(
     ...
     */
    protected static String generateBibliography(
            List<BibEntry> bibEntries, String style, BibEntryTypesManager entryTypesManager) {
     ...
     * @implNote the citation is generated using JavaScript which may take some time, better call it from outside the main Thread
     */
    public static List<String> generateBibliography(
            List<BibEntry> bibEntries,
            String style,
            CitationStyleOutputFormat outputFormat,
            BibDatabaseContext databaseContext,
            BibEntryTypesManager entryTypesManager) {
        return generateBibliographies(
                bibEntries, style, outputFormat, databaseContext, entryTypesManager);
    }
    ...
    public static Citation generateCitation(
            ...
            BibEntryTypesManager entryTypesManager)
            throws IOException {
        return CSL_ADAPTER.makeCitation(
                bibEntries, style, outputFormat, databaseContext, entryTypesManager);
    }
     ...
     */
    public static List<String> generateBibliographies(
            List<BibEntry> bibEntries,
            String style,
            CitationStyleOutputFormat outputFormat,
            BibDatabaseContext databaseContext,
