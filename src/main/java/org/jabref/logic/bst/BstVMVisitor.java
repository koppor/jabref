...
class BstVMVisitor extends BstBaseVisitor<Integer> {
    ...
    public Integer visitFunctionCommand(BstParser.FunctionCommandContext ctx) {
        ...
        bstVMContext
                .functions()
                .put(name, (visitor, functionContext) -> visitor.visit(ctx.function));
        return BstVM.TRUE;
    }
        ...
        FieldWriter fieldWriter =
                new FieldWriter(
                        new FieldPreferences(
                                true, List.of(StandardField.MONTH), Collections.emptyList()));
                                        ...
                                        content -> {
                                            try {
                                                ...
                                                if (field == StandardField.MONTH) {
                                                    // We don't have the internal BibTeX strings at
                                                    // hand.
                                                    // Thus, we look up the full month name in the
                                                    // generic table.
                                                ...
                                                // content, just return the content itself
                                                return content;
                                            }
                                        })
                                .orElse(null);
