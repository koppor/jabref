...
public class LlmPlainCitationParser implements PlainCitationParser {
    ...
    private static final PromptTemplate USER_MESSAGE_TEMPLATE =
            PromptTemplate.from(
    ...
    public LlmPlainCitationParser(
            ImportFormatPreferences importFormatPreferences, ChatLanguageModel llm) {
    ...
    public Optional<BibEntry> parsePlainCitation(String text) throws FetcherException {
        try {
            return BibtexParser.singleFromString(
                    getBibtexStringFromLlm(text), importFormatPreferences);
        ...
        return llm.generate(
                        ...
                        new UserMessage(
                                USER_MESSAGE_TEMPLATE
                                        .apply(Map.of("citation", searchQuery))
                                        .toString()))
                .content()
                .text();
    }
