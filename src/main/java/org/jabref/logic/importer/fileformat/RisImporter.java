        ...
        for (String entry1 : entries) {
            ...
            for (int j = 0; j < lines.length; j++) {
                ...
                if (entry.length() < 6) {
                    ...
                    } else if (((tagPriority = dateTags.indexOf(tag)) != -1)
                            && (value.length() >= 4)) {
            ...
            // month has a special treatment as we use the separate method "setMonth" of BibEntry
