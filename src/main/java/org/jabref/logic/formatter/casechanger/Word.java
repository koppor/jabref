...
public final class Word {
    ...
    // Conjunctions used as part of Title case capitalisation to specifically check if word is
    // conjunction or not
    public static final Set<String> CONJUNCTIONS =
            Set.of("and", "but", "for", "nor", "or", "so", "yet");
    ...
    static {
        ...
        smallerWords.addAll(
                Arrays.asList(
                        ...
                        "near", "of", "off", "on", "onto", "since", "to", "toward", "through",
                        "under", "until", "up", "upon", "with", "within", "without"));

        // Conjunctions used as part of all case capitalisation to check if it is a small word or
        // not
