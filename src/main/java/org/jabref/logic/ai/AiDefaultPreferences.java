...
public class AiDefaultPreferences {
    public static final Map<AiProvider, List<String>> AVAILABLE_CHAT_MODELS =
            Map.of(
                    AiProvider.OPEN_AI,
                            List.of(
                                    "gpt-4o-mini",
                    ...
                    AiProvider.GEMINI,
                            List.of("gemini-1.5-flash", "gemini-1.5-pro", "gemini-1.0-pro"),
                    AiProvider.HUGGING_FACE, List.of());

    public static final Map<AiProvider, String> PROVIDERS_PRIVACY_POLICIES =
            Map.of(
    ...
    public static final Map<AiProvider, String> PROVIDERS_API_URLS =
            Map.of(
    ...
    public static final Map<AiProvider, Map<String, Integer>> CONTEXT_WINDOW_SIZES =
            Map.of(
                    AiProvider.OPEN_AI,
                            Map.of(
                                    "gpt-4o-mini", 128000,
    ...
    public static final Map<AiProvider, String> CHAT_MODELS =
            Map.of(
