...
public class ExporterFactory {
    ...
    public static ExporterFactory create(
            PreferencesService preferencesService, BibEntryTypesManager entryTypesManager) {

        List<TemplateExporter> customFormats =
                preferencesService.getExportPreferences().getCustomExporters();
        ...
        exporters.add(new TemplateExporter(
                "HTML", "html", "html", null, StandardFileType.HTML, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
                ...
                saveOrder));
        exporters.add(new TemplateExporter(
                "DocBook 5.1", "docbook5", "docbook5", null, StandardFileType.XML, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
                "DocBook 4", "docbook4", "docbook4", null, StandardFileType.XML, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
                "DIN 1505",
                "din1505",
                "din1505winword",
                ...
                saveOrder));
        exporters.add(new TemplateExporter(
                "BibO RDF", "bibordf", "bibordf", null, StandardFileType.RDF, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
        ...
        exporters.add(new TemplateExporter(
                ...
                saveOrder));
        exporters.add(new TemplateExporter(
                "Harvard RTF", "harvard", "harvard", "harvard", StandardFileType.RTF, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
                "ISO 690 RTF",
                "iso690rtf",
                "iso690RTF",
                ...
                saveOrder));
        exporters.add(new TemplateExporter(
                "ISO 690", "iso690txt", "iso690", "iso690txt", StandardFileType.TXT, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
                "Endnote", "endnote", "EndNote", "endnote", StandardFileType.TXT, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
        ...
        exporters.add(new TemplateExporter(
                "MIS Quarterly", "misq", "misq", "misq", StandardFileType.RTF, layoutPreferences, saveOrder));
        exporters.add(new TemplateExporter(
                "CSL YAML",
                "yaml",
                "yaml",
    ...
    public Optional<Exporter> getExporterByName(String consoleName) {
        return exporters.stream()
                .filter(exporter -> exporter.getId().equalsIgnoreCase(consoleName))
                .findFirst();
    }
}
