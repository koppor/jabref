...
public class ExporterFactory {
    ...
    public static ExporterFactory create(
            CliPreferences preferences, BibEntryTypesManager entryTypesManager) {
        ...
        SelfContainedSaveOrder saveOrder =
                SelfContainedSaveOrder.of(
                        preferences.getSelfContainedExportConfiguration().getSaveOrder());
        ...
        exporters.add(
                new EmbeddedBibFilePdfExporter(
                        bibDatabaseMode, entryTypesManager, fieldPreferences));
