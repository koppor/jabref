...
class ControlHelperTest {
    ...
    void truncateWithTextNullAndEmptyReturnsSource(String text) {
        String truncatedText =
                ControlHelper.truncateString(
                        text, MAX_CHARACTERS, ELLIPSIS_STRING, ELLIPSIS_POSITION);
    ...
    void truncateWithDefaultMaxCharactersReturnsText() {
        String truncatedText =
                ControlHelper.truncateString(
                        TEXT, DEFAULT_MAX_CHARACTERS, ELLIPSIS_STRING, ELLIPSIS_POSITION);
        assertEquals(TEXT, truncatedText);
    }
    ...
    void truncateWithDefaultMaxCharactersAndNullEllipsisAndPositionEndingReturnsTruncatedText() {
        ...
        String truncatedText =
                ControlHelper.truncateString(
                        text, DEFAULT_MAX_CHARACTERS, null, ControlHelper.EllipsisPosition.ENDING);
    ...
    void truncateWithNullEllipsisPositionThrowsNullPointerException(
        ...
        assertThrows(
                ...
                () ->
                        ControlHelper.truncateString(
                                TEXT, MAX_CHARACTERS, ELLIPSIS_STRING, ellipsisPosition));
    }
}
