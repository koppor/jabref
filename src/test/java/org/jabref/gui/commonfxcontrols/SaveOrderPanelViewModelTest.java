...
class SaveOrderPanelViewModelTest {
    ...
    void removeCriterion() {
        ...
        assertEquals(
                List.of(sortCriterionKey, sortCriterionTitle), viewModel.sortCriteriaProperty());
    }
    ...
    void moveCriterionUp() {
        ...
        assertEquals(
                List.of(sortCriterionKey, sortCriterionTitle, sortCriterionAuthor),
                viewModel.sortCriteriaProperty());

        viewModel.moveCriterionUp(sortCriterionTitle);
        assertEquals(
                List.of(sortCriterionTitle, sortCriterionKey, sortCriterionAuthor),
                viewModel.sortCriteriaProperty());
    ...
    void moveCriterionDown() {
        ...
        assertEquals(
                List.of(sortCriterionAuthor, sortCriterionKey, sortCriterionTitle),
                viewModel.sortCriteriaProperty());

        viewModel.moveCriterionDown(sortCriterionKey);
        assertEquals(
                List.of(sortCriterionAuthor, sortCriterionTitle, sortCriterionKey),
                viewModel.sortCriteriaProperty());
