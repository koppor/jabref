...
class ContentSelectorViewModelTest {
    ...
    void initHasDefaultFieldNames() {
        ListProperty<Field> expected =
                new SimpleListProperty<>(FXCollections.observableArrayList(DEFAULT_FIELDS));
    ...
    void addsNewKeyword() {
        ...
        ListProperty<String> expected =
                new SimpleListProperty<>(FXCollections.observableArrayList("test"));
    ...
    void addsNewField() {
        ...
        boolean fieldsContainTestValue =
                fields.stream().anyMatch(field -> "Test".equals(field.getDisplayName()));
    ...
    void displaysKeywordsInAlphabeticalOrder() {
        ...
        ListProperty<String> expected =
                new SimpleListProperty<>(FXCollections.observableArrayList("test1", "test2"));
        ListProperty<String> result = viewModel.getKeywordsBackingList();
    ...
    void savingPersistsDataInDatabase() {
        ...
        List<String> result =
                databaseContext.getMetaData().getContentSelectorValuesForField(testField);
    ...
    private void removeKeyword(Field field, String keyword) {
        when(dialogService.showConfirmationDialogAndWait(
                        ...
                        Localization.lang(
                                "Are you sure you want to remove keyword: \"%0\"?", keyword)))
                .thenReturn(true);
