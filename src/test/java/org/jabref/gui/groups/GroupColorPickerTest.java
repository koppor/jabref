...
class GroupColorPickerTest {
    ...
    static Stream<Arguments> generateColor() {
        return Stream.of(
                Arguments.of(Color.hsb(180, 1.0, 1.0), List.of(Color.hsb(0, 1.0, 1.0))),
                Arguments.of(
                        Color.hsb(270, 1.0, 1.0),
                        List.of(Color.hsb(0, 1.0, 1.0), Color.hsb(180, 1.0, 1.0))),
                Arguments.of(
                        Color.hsb(270, 1.0, 1.0),
                        List.of(
                                Color.hsb(0, 1.0, 1.0),
    ...
    void generateColor(Color expected, List<Color> subgroupColors) {
        ...
        assertEquals(
                expected, result, "%s != %s".formatted(colorToHsb(expected), colorToHsb(result)));
    }
}
