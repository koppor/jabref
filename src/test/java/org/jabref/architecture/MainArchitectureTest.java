...
class MainArchitectureTest {
    ...
    public void doNotUseApacheCommonsLang3(JavaClasses classes) {
        noClasses()
                .that()
                .areNotAnnotatedWith(AllowedToUseApacheCommonsLang3.class)
                .should()
                .accessClassesThat()
    ...
    public void useStreamsOfResources(JavaClasses classes) {
        ...
        noClasses()
                ...
                .and()
                .areNotAnnotatedWith(AllowedToUseClassGetResource.class)
                .and()
                .areNotAssignableFrom(ImporterTestEngine.class)
                .should()
    ...
    public void respectLayeredArchitecture(JavaClasses classes) {
        ...
        layeredArchitecture()
                ...
                .whereLayer(GUI)
                .mayOnlyBeAccessedByLayers(CLI, Migrations)
                .whereLayer(Logic)
                .mayOnlyBeAccessedByLayers(GUI, CLI, Model, Migrations)
                .whereLayer(Model)
                .mayOnlyBeAccessedByLayers(GUI, Logic, Migrations, CLI)
                ...
                .mayOnlyBeAccessedByLayers(GUI, Logic)
                .check(classes);
    }
    ...
    public void restrictUsagesInModel(JavaClasses classes) {
        // Until we switch to Lucene, we need to access Globals.stateManager().getActiveDatabase()
        // from the search classes,
    ...
    public void restrictUsagesInLogic(JavaClasses classes) {
        noClasses()
                ...
                .areNotAnnotatedWith(AllowedToUseSwing.class)
                .and()
                .areNotAssignableFrom("org.jabref.logic.search.DatabaseSearcherWithBibFilesTest")
                .should()
                .dependOnClassesThat()
                .resideInAPackage(PACKAGE_JAVAX_SWING)
                .check(classes);
