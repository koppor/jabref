...
class MainArchitectureTest {
    ...
    public static void respectLayeredArchitecture(JavaClasses classes) {
        layeredArchitecture()
                ...
                .mayOnlyBeAccessedByLayers(
                        "Gui", "Logic", "Migrations", "Styletester", "Cli") // TODO: Remove logic here
                .check(classes);
    }
    ...
    public static void restrictUsagesInModel(JavaClasses classes) {
        // Until we switch to Lucene, we need to access Globals.stateManager().getActiveDatabase() from the search
        // classes,
