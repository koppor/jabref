...
public class TestArchitectureTest {
    ...
    public void testsAreIndependent(JavaClasses classes) {
        noClasses()
                ...
                .and()
                .doNotHaveFullyQualifiedName("org.jabref.testutils.interactive.styletester.StyleTesterMain")
                .should()
                .dependOnClassesThat()
                .haveFullyQualifiedName(CLASS_ORG_JABREF_GLOBALS)
                .orShould()
                .dependOnClassesThat()
                .haveFullyQualifiedName(CLASS_ORG_JABREF_PREFERENCES)
                .check(classes);
    }
    ...
    public void testNaming(JavaClasses classes) {
        classes()
                ...
                .doNotHaveFullyQualifiedName("org.jabref.testutils.interactive.styletester.StyleTesterMain")
                .and()
                .doNotHaveFullyQualifiedName("org.jabref.testutils.interactive.styletester.StyleTesterView")
                .should()
