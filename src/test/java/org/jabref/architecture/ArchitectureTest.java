...
public class ArchitectureTest {
    ...
    private static final String CLASS_ORG_JABREF_GUI_PREFERENCES =
            "org.jabref.logic.preferences.GuiPreferences";

    @ArchTest
    public void testsAreIndependentOfGuiPreferences(JavaClasses classes) {
        noClasses()
                .that()
                .doNotHaveSimpleName("EntryEditorTest")
                .and()
                .doNotHaveSimpleName("LinkedFileViewModelTest")
                .and()
                .doNotHaveSimpleName("JabRefPreferencesTest")
                .and()
                .doNotHaveSimpleName("PreferencesMigrationsTest")
                .and()
                .doNotHaveSimpleName("SaveDatabaseActionTest")
                .and()
                .doNotHaveSimpleName("UpdateTimestampListenerTest")
                .and()
                .doNotHaveSimpleName("DatabaseSearcherWithBibFilesTest")
                .and()
                .doNotHaveFullyQualifiedName("org.jabref.benchmarks.Benchmarks")
                .and()
                .doNotHaveFullyQualifiedName(
                        "org.jabref.testutils.interactive.styletester.StyleTesterMain")
                .should()
                .dependOnClassesThat()
                .haveFullyQualifiedName(CLASS_ORG_JABREF_GUI_PREFERENCES)
                .check(classes);
    }
    ...
    public void testNaming(JavaClasses classes) {
        classes()
                ...
                .and()
                .doNotHaveFullyQualifiedName("org.jabref.logic.util.CurrentThreadTaskExecutor")
                .and()
                ...
                .and()
                .doNotHaveFullyQualifiedName(
                        "org.jabref.testutils.interactive.styletester.StyleTesterView")
                .should()
