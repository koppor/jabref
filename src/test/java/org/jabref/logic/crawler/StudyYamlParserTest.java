...
class StudyYamlParserTest {
    ...
    void setupStudy() throws Exception {
        ...
        URL studyDefinition =
                StudyYamlParser.class.getResource(StudyRepository.STUDY_DEFINITION_FILE_NAME);
        ...
        expectedStudy =
                new Study(authors, studyName, researchQuestions, queryEntries, libraryEntries);
    }
    ...
    void parseStudyFileSuccessfully() throws Exception {
        Study study =
                new StudyYamlParser()
                        .parseStudyYamlFile(
                                testDirectory.resolve(StudyRepository.STUDY_DEFINITION_FILE_NAME));
    ...
    void readsJabRef57StudySuccessfully() throws Exception {
        ...
        // "last-search-date" (class org.jabref.model.study.Study), not marked as ignorable (5 known
        // properties: "authors", "research-questions", "queries", "title", "databases"])
