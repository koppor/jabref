...
class CSLFormatUtilsTest {
    ...
    private final BibDatabaseContext context =
            new BibDatabaseContext(new BibDatabase(List.of(TestEntry.getTestEntry())));
    ...
    static Stream<Arguments> ooHTMLTransformFromRawHTML() {
        return Stream.of(
                ...
                Arguments.of("Smith & Jones", "Smith &amp; Jones"),
                ...
                Arguments.of("<b>Bold Text</b>", "&lt;b&gt;Bold Text&lt;/b&gt;"),
                ...
                Arguments.of("Aligned text", "<div style=\"text-align:left;\">Aligned text</div>"),

                // Removing unsupported links
                Arguments.of("Text with link", "Text with <a href=\"http://example.com\">link</a>"),
                ...
                Arguments.of(
                        "Text with unnecessary span", "Text with <span>unnecessary span</span>"),
        ...
        return Stream.of(
                ...
                Arguments.of(
                        "  \n"
                                ...
                                + "  \n",
                        STYLE_LIST.stream()
                                .filter(e -> "IEEE".equals(e.getTitle()))
                                .findAny()
                                .get()),
                ...
                Arguments.of(
                        "  \n"
                                ...
                                + "  \n",
                        STYLE_LIST.stream()
                                .filter(e -> "Vancouver".equals(e.getTitle()))
                                .findAny()
                                .get()),
                Arguments.of(
                        "  \n"
                                ...
                                + "  \n",
                        STYLE_LIST.stream()
                                .filter(e -> "Nature".equals(e.getTitle()))
                                .findAny()
                                .get()),
                Arguments.of(
                        "  \n"
                ...
                Arguments.of(
                        ...
                        STYLE_LIST.stream()
                                .filter(e -> "Histoire & Mesure (Français)".equals(e.getTitle()))
                                .findAny()
                                .get()),
                ...
                Arguments.of(
                        "  \n"
                                ...
                                + "  \n",
                        STYLE_LIST.stream()
                                .filter(e -> "Acta Orthopædica Belgica".equals(e.getTitle()))
                                .findAny()
                                .get()),
                ...
                Arguments.of(
                        "  \n"
                                ...
                                + "  \n",
                        STYLE_LIST.stream()
                                .filter(e -> "American Chemical Society".equals(e.getTitle()))
                                .findAny()
                                .get()),
    ...
    static Stream<Arguments> ooHTMLTransformFromCitationWithSingleEntry() {
        return Stream.of(
                ...
                // Note: not sure if the right parenthesis outside the superscript is correct, but
                // that's how citeproc-java generates it in raw form as well.
                Arguments.of(
                        "<sup>1</sup>)",
                        STYLE_LIST.stream()
                                .filter(
    ...
    private static Stream<Arguments> generateAlphanumericCitationTest() {
        ...
        BibEntry entry3 =
                new BibEntry(StandardEntryType.Article)
                        .withField(
                                ...
                                "Johnson, Emily; Williams, Jessica; Lee, David")
        ...
        BibEntry entry4 =
                new BibEntry(StandardEntryType.Article)
                        .withField(
                                StandardField.AUTHOR,
                                "Smith, John; Johnson, Emily; Lee, David; Williams, Jessica")
        ...
        BibEntry entry5 =
                new BibEntry(StandardEntryType.Article)
                        .withField(
                                StandardField.AUTHOR,
                                "Garcia, Maria; Smith, John; Johnson, Emily; Lee, David; Williams, Jessica")
