...
class MakeLabelWithoutDatabaseTest {
    ...
    void bamford_1972_Comprehensive_Reaction_V_7_EN() {
        ...
        BibEntry entry =
                new BibEntry(StandardEntryType.Book)
                        ...
                        .withField(
                                StandardField.TITLE,
                                "Reaction of Metallic Salts and Complexes, and Organometallic Compounds")
    ...
    void frenchRegEx() {
        BibEntry entry =
                new BibEntry(StandardEntryType.Book).withField(StandardField.LANGUAGE, "french");
        citationKeyGenerator =
                new CitationKeyGenerator(
                        GlobalCitationKeyPatterns.fromPattern(
                                "[LANGUAGE:regex(\"english\", \"EN\"):regex(\"french\", \"FR\")]"),
                        new BibDatabase(),
                        patternPreferences);
        String label = citationKeyGenerator.generateKey(entry);
