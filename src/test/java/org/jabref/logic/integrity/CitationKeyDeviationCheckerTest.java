...
class CitationKeyDeviationCheckerTest {
    ...
    private final AbstractCitationKeyPatterns abstractCitationKeyPatterns =
            mock(AbstractCitationKeyPatterns.class);
    private final GlobalCitationKeyPatterns globalCitationKeyPatterns =
            mock(GlobalCitationKeyPatterns.class);
    ...
    void setUp() {
        ...
        when(metaData.getCiteKeyPatterns(citationKeyPatternPreferences.getKeyPatterns()))
                .thenReturn(abstractCitationKeyPatterns);
