...
class ASCIICharacterCheckerTest {
        ...
        assertEquals(
                List.of(
                        new IntegrityMessage(
                                "Non-ASCII encoded character found", entry, StandardField.MONTH)),
                checker.check(entry));
    }
    ...
    void fieldDoesNotAcceptUnicode() {
        ...
        assertEquals(
                List.of(
                        new IntegrityMessage(
                                "Non-ASCII encoded character found", entry, StandardField.AUTHOR)),
                checker.check(entry));
    }
    ...
    void fieldDoesNotAcceptNonAsciiCharacters() {
        ...
        assertEquals(
                List.of(
                        new IntegrityMessage(
                                "Non-ASCII encoded character found", entry, StandardField.TITLE)),
                checker.check(entry));
    }
}
