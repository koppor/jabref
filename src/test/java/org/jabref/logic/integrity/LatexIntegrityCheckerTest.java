...
public class LatexIntegrityCheckerTest {
    ...
    private static Stream<Arguments> provideAcceptedInputs() {
        return Stream.of(
                ...
                // Arguments.of(StandardField.TITLE, "\\begin{align*} x + y &= z \\\\ a &= b + c \\\\ p &= \\frac{q}{r}
                // \\end{align*}"),
                Arguments.of(
                        StandardField.TITLE,
                ...
                // \\includegraphics[width=0.8\\textwidth]{plot.png} \\caption{Plot Caption} \\label{fig:plot}
                // \\end{figure}"),
                ...
                Arguments.of(
                        StandardField.ABSTRACT, "\\textless{}xml\\textgreater{} \\textbar something \textbackslash"),
    ...
    private static Stream<Arguments> provideUnacceptedInputs() {
        return Stream.of(
                ...
                // Arguments.of(LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEG02, "€", "20AC", "3"),
                // StandardField.TITLE, "A title with € symbol"),
                ...
                // Excluded
                // Arguments.of(LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEG04),
                // StandardField.FOREWORD, "Text with #1 placeholder"),
                ...
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEC00, "undefinedCommand"),
                        StandardField.ABSTRACT,
                        "\\undefinedCommand"),
                ...
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEE00, "align", "itemize"),
                        StandardField.ABSTRACT,
                ...
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEE02, "undefinedEnv"),
                        StandardField.ABSTRACT,
                        "\\begin{undefinedEnv}"),

                // TTEE03: Environment {0} cannot be used in {1} mode
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEE03, "itemize", "MATH"),
                        StandardField.TITLE,
                        "$\\begin{itemize}$"),
                ...
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEE06, "tabular", "1"),
                        StandardField.TITLE,
                        "\\begin{tabular}\\end{tabular}"),

                // TTEU00: Expansion limit ({0}) for user-defined commands and environments has been exceeded. Possible
                // recursion?
                // Skipped
                ...
                // TTEUC7: Number of arguments specified in command or environment definition {0} must be an integer
                // between 1 and 9 - not {1}
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEUC7, "MyCommand", "0"),
                        StandardField.TITLE,
                ...
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEUCA, "MyCommand", "2", "1"),
                        StandardField.TITLE,
                ...
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEUE1, "begin", "MyEnvironment"),
                        StandardField.TITLE,
                ...
                // TTEUE5: Definition of begin of environment {0} refers to argument #{1} but only {2} have been
                // declared
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEUE5, "MyEnvironment", "1", "0"),
                        StandardField.TITLE,
                        "\\newenvironment{MyEnvironment}{#1}{}"),

                // TTEUE6: Definition of end of environment {0} refers to argument #{1} but arguments may not be used
                // here
                Arguments.of(
                        LatexIntegrityChecker.errorMessageFormatHelper(CoreErrorCode.TTEUE6, "MyEnvironment", "2"),
                        StandardField.TITLE,
