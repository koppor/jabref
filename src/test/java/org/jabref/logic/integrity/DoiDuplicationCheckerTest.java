    ...
    public void testOnePairDuplicateDOI() {
        ...
        List<IntegrityMessage> results = List.of(
                new IntegrityMessage(
                        Localization.lang("Same DOI used in multiple entries"), doiA_entry1, StandardField.DOI),
                new IntegrityMessage(
                        Localization.lang("Same DOI used in multiple entries"), doiA_entry2, StandardField.DOI));
    ...
    public void testMultiPairsDuplicateDOI() {
        ...
        List<IntegrityMessage> results = List.of(
                ...
                new IntegrityMessage(
                        Localization.lang("Same DOI used in multiple entries"), doiA_entry2, StandardField.DOI),
                new IntegrityMessage(
                        Localization.lang("Same DOI used in multiple entries"), doiB_entry1, StandardField.DOI),
                new IntegrityMessage(
                        Localization.lang("Same DOI used in multiple entries"), doiB_entry2, StandardField.DOI));
        assertEquals(results, checker.check(database));
    }
