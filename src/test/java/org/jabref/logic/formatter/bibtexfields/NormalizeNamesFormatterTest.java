...
class NormalizeNamesFormatterTest {
    ...
    void normalizeAuthorList() {
        assertEquals(
                ...
                formatter.format("{Society of Automotive Engineers}"));
    ...
    void twoAuthorsSeperatedByColon() {
        assertEquals(
                "Bilbo, Staci and Alver, Morten", formatter.format("Staci Bilbo; Morten Alver"));
    }
    ...
    void formatExample() {
        assertEquals(
                "Einstein, Albert and Turing, Alan", formatter.format(formatter.getExampleInput()));
    }
