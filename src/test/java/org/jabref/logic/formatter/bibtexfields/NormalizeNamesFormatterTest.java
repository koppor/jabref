...
public class NormalizeNamesFormatterTest {
    ...
    public void testNameAffixe() {
        assertEquals(
                "Surname, jr, First and Surname2, First2", formatter.format("Surname, jr, First, Surname2, First2"));
    }
    ...
    public void testAndInName() {
        assertEquals(
                "Surname and , First, Surname2 First2", formatter.format("Surname, and , First, Surname2, First2"));
    }
    ...
    public void testOneCommaUntouched() {
        assertEquals(
                "Canon der Barbar, Alexander der Große", formatter.format("Canon der Barbar, Alexander der Große"));
    }
