    ...
    private static Stream<Arguments> provideURL() {
        return Stream.of(
                ...
                Arguments.of(
                        new BibEntry()
                                .withField(
                                        StandardField.URL, "https://hdl.handle.net/10442/hedi/6089")
                ...
                Arguments.of(
                        new BibEntry()
                                .withField(
                                        StandardField.URL, "http://hdl.handle.net/10442/hedi/6089"),
                        new BibEntry()
                                .withField(
                                        StandardField.NOTE,
                ...
                Arguments.of(
                        ...
                        new BibEntry()
                                .withField(StandardField.NOTE, "\\url{http://☺.damowmow.com}")),
                Arguments.of(
                        new BibEntry()
                                .withField(
                                        StandardField.URL,
