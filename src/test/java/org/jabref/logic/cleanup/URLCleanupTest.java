    ...
    private static Stream<Arguments> provideURL() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        new BibEntry()
                                .withField(StandardField.NOTE, "\\url{https://example.org}, cited by Kramer, 2002.")),
                ...
                Arguments.of(
                        ...
                        new BibEntry().withField(StandardField.NOTE, "\\url{http://hdl.handle.net/10442/hedi/6089}")),
                Arguments.of(
                        new BibEntry().withField(StandardField.URL, "http://userid:password@example.com:8080"),
                        new BibEntry().withField(StandardField.NOTE, "\\url{http://userid:password@example.com:8080}")),
                Arguments.of(
                ...
                Arguments.of(
                        new BibEntry()
                                .withField(StandardField.URL, "http://-.~_!$&'()*+,;=:%40:80%2f::::::@example.com"),
                        new BibEntry()
                                .withField(
                                        StandardField.NOTE,
                ...
                Arguments.of(
                        new BibEntry()
                                .withField(StandardField.URL, "https://www.example.com/foo/?bar=baz&inga=42&quux"),
                        new BibEntry()
                                .withField(
                                        StandardField.NOTE,
                ...
                Arguments.of(
                        new BibEntry()
                                .withField(StandardField.URL, "https://www.example.com/foo/?bar=baz&inga=42&quux"),
                        new BibEntry()
                                .withField(StandardField.NOTE, "https://www.example.com/foo/?bar=baz&inga=42&quux")),
                ...
                Arguments.of(
                        ...
                        new BibEntry()
                                .withField(StandardField.NOTE, "\\url{http://142.42.1.1:8080}, visited on 2015.01.15")
                                .withField(StandardField.URLDATE, "2015-01-15")),
