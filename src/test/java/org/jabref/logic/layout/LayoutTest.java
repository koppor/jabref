...
class LayoutTest {
    ...
    void entryTypeForArticle() throws IOException {
        BibEntry entry =
                new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "test");
    ...
    void entryTypeForMisc() throws IOException {
        BibEntry entry =
                new BibEntry(StandardEntryType.Misc).withField(StandardField.AUTHOR, "test");
    ...
    void HTMLCharWithDoubleLineBreak() throws IOException {
        ...
        String layoutText =
                layout("\\begin{author}\\format[HTMLChars]{\\author}\\end{author} ", entry);
    ...
    void nameFormatter() throws IOException {
        ...
        String layoutText =
                layout("\\begin{author}\\format[NameFormatter]{\\author}\\end{author}", entry);
    ...
    void beginConditionals() throws IOException {
        BibEntry entry =
                new BibEntry(StandardEntryType.Misc).withField(StandardField.AUTHOR, "Author");
    ...
    void expandCommandIfTerminatedByMinus() throws IOException {
        BibEntry entry =
                new BibEntry(StandardEntryType.Article).withField(StandardField.EDITION, "2");
    ...
    void annotatedField() throws IOException {
        ...
        assertEquals(
                "Joe Doe and Mary Jane: Joe Doe and Mary Jane 1:corresponding,2:highlight",
                layoutText);
    }
}
