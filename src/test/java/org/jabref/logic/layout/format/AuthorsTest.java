...
class AuthorsTest {
    ...
    void standardUsageOne() {
        ...
        assertEquals(
                "Bruce, Bob Croydon, Jumper, Jolly",
    ...
    void standardUsageFive() {
        ...
        assertEquals(
                "Bruce, Bob Croydon et al.",
                authorsLayoutFormatter.format(
                        "Bob Croydon Bruce and Charles Manson and Jolly Jumper and Chuck Chuckles"));
    }
    ...
    void standardUsageSix() {
        ...
        assertEquals(
                "Bruce, Bob Croydon, Manson, Charles et al.",
                authorsLayoutFormatter.format(
                        "Bob Croydon Bruce and Charles Manson and Jolly Jumper and Chuck Chuckles"));
    }
    ...
    void lastName() {
        ...
        assertEquals(
                "Bruce, von Manson and Jumper",
                authorsLayoutFormatter.format(
                        "Bruce, Bob Croydon and Charles von Manson and Jolly Jumper"));
    }
    ...
    void middleInitial() {
        ...
        assertEquals(
                "Bob C. Bruce, Charles K. von Manson and Jolly Jumper",
                authorsLayoutFormatter.format(
                        "Bruce, Bob Croydon and Charles Kermit von Manson and Jumper, Jolly"));
    }
    ...
    void noPeriod() {
        ...
        assertEquals(
                "B C Bruce, C K von Manson and J Jumper",
                authorsLayoutFormatter.format(
                        "Bruce, Bob Croydon and Charles Kermit von Manson and Jumper, Jolly"));
    }
