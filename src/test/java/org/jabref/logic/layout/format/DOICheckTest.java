...
class DOICheckTest {
    ...
    void formatDOIWithCustomBase() {
        ...
        assertEquals(
                "http://example.org/10.1000/ISBN1-900512-44-0",
                layoutFormatter.format("10.1000/ISBN1-900512-44-0"));
    }
    ...
    private static Stream<Arguments> provideDOI() {
        return Stream.of(
                ...
                Arguments.of(
                        "https://doi.org/10.1000/ISBN1-900512-44-0", "10.1000/ISBN1-900512-44-0"),
                Arguments.of(
