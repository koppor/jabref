...
public class JavaLocalizationEntryParserTest {
    public static Stream<Arguments> singleLineChecks() {
        return Stream.of(
                ...
                // '\c' is an escaped character, thus "\cite" is wrong as lookup text. It has to be "\\cite" in the
                // .properties file
    ...
    public static Stream<Arguments> multiLineChecks() {
        return Stream.of(Arguments.of(
                ...
                Arrays.asList("two per line", "two per line")));
    }
    ...
    public void testLocalizationKeyParsing(String code, List<String> expectedLanguageKeys) {
        List<String> languageKeysInString =
                JavaLocalizationEntryParser.getLanguageKeysInString(code, LocalizationBundleForTest.LANG);
    ...
    public void testLocalizationParameterParsing(String code, String expectedParameter) {
        List<String> languageKeysInString =
                JavaLocalizationEntryParser.getLocalizationParameter(code, LocalizationBundleForTest.LANG);
