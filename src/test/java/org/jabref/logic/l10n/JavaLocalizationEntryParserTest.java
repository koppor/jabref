...
public class JavaLocalizationEntryParserTest {
    public static Stream<Arguments> singleLineChecks() {
        return Stream.of(
                ...
                // '\c' is an escaped character, thus "\cite" is wrong as lookup text. It has to be
                // "\\cite" in the .properties file
                Arguments.of(
    ...
    void localizationKeyParsing(String code, List<String> expectedLanguageKeys) {
        List<String> languageKeysInString =
                JavaLocalizationEntryParser.getLanguageKeysInString(
                        code, LocalizationBundleForTest.LANG);
