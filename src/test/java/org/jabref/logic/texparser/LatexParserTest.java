...
class LatexParserTest {
    ...
    void setUp() {
        ...
        BibEntry einstein =
                new BibEntry(StandardEntryType.Book)
                        ...
                        .withField(
                                StandardField.TITLE, "Relativity: The special and general theory")
    ...
    void sameFileDifferentDatabases() throws URISyntaxException {
        ...
        LatexBibEntriesResolverResult crossingResult =
                new TexBibEntriesResolver(database, importFormatPreferences, fileMonitor)
        ...
        LatexBibEntriesResolverResult crossingResult2 =
                new TexBibEntriesResolver(database2, importFormatPreferences, fileMonitor)
                        .resolve(new LatexParserResults(parserResult));
    ...
    void twoFilesDifferentDatabases() throws URISyntaxException {
        ...
        LatexParserResults expectedParserResults =
                new LatexParserResults(expectedParserResult, expectedParserResult2);

        LatexBibEntriesResolverResult expectedCrossingResult =
                new LatexBibEntriesResolverResult(expectedParserResults);
