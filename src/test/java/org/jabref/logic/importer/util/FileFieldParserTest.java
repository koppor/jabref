...
class FileFieldParserTest {
    ...
    private static Stream<Arguments> stringsToParseTest() throws Exception {
        return Stream.of(
                ...
                // Mendeley input
                Arguments.of(
                        Collections.singletonList(new LinkedFile(
                                "",
                                Path.of(
                ...
                Arguments.of(
                        Collections.singletonList(new LinkedFile("", Path.of("wei2005ahp.pdf"), "")), "wei2005ahp.pdf"),
                ...
                Arguments.of(
                        Collections.singletonList(new LinkedFile(
                                "Boyd2012.pdf", Path.of("C:\\Users\\Literature_database\\Boyd2012.pdf"), "PDF")),
                        "Boyd2012.pdf:C\\:\\\\Users\\\\Literature_database\\\\Boyd2012.pdf:PDF"),

                // subsetOfFieldsResultsInFileLink: description only
                Arguments.of(Collections.singletonList(new LinkedFile("", Path.of("file.pdf"), "")), "file.pdf::"),
