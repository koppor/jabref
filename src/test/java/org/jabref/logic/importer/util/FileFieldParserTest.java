...
class FileFieldParserTest {
    ...
    private static Stream<Arguments> testData() {
        return Stream.of(
                Arguments.of(
                        new LinkedFile(
                                "arXiv Fulltext PDF",
                                "https://arxiv.org/pdf/1109.0517.pdf",
                                "application/pdf"),
                        List.of(
                                "arXiv Fulltext PDF",
                                "https://arxiv.org/pdf/1109.0517.pdf",
    ...
    void check(LinkedFile expected, List<String> input) {
        // we need to convert the unmodifiable list to a modifiable because of the side effect of
        // "convert"
    ...
    private static Stream<Arguments> stringsToParseTest() throws Exception {
        return Stream.of(
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile(
                                        "",
                                        Path.of(
                                                "C:/Users/XXXXXX/AppData/Local/Mendeley Ltd./Mendeley Desktop/Downloaded/Brown - 2017 - Physical test methods for elastomers.pdf"),
                                        "pdf")),
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile(
                                        URI.create("http://arxiv.org/pdf/2010.08497v1").toURL(),
                                        "PDF")),
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile("test:;", Path.of("wei2005ahp.pdf"), "PDF")),
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile(
                                        "Boyd2012.pdf",
                                        Path.of("C:\\Users\\Literature_database\\Boyd2012.pdf"),
                                        "PDF")),
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile("desc", Path.of("file.pdf"), "PDF", "qwer")),
                        "desc:file.pdf:PDF:qwer:asdf:uiop"),

                // www inside filename
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile("", Path.of("/home/www.google.de.pdf"), "")),
                        ":/home/www.google.de.pdf"),

                // url
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile(URI.create("https://books.google.de/").toURL(), "")),
                        "https://books.google.de/"),

                // url with www
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile(URI.create("https://www.google.de/").toURL(), "")),
                        "https://www.google.de/"),
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile(
                                        "",
                                        URI.create("http://ceur-ws.org/Vol-438").toURL(),
                                        "URL")),
                ...
                Arguments.of(
                        Collections.singletonList(
                                new LinkedFile("", "A:\\Zotero\\storage\\test.pdf", "")),
