...
class GroupsParserTest {
    ...
    void fromStringParsesExplicitGroupWithEscapedCharacterInName() throws Exception {
        ExplicitGroup expected =
                new ExplicitGroup("B{\\\"{o}}hmer", GroupHierarchyType.INDEPENDENT, ',');
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "ExplicitGroup:B{\\\\\"{o}}hmer;0;", ',', fileMonitor, metaData);
    ...
    void keywordDelimiterThatNeedsToBeEscaped() throws Exception {
        AutomaticGroup expected =
                new AutomaticKeywordGroup(
                        "group1", GroupHierarchyType.INDEPENDENT, StandardField.KEYWORDS, ';', '>');
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "AutomaticKeywordGroup:group1;0;keywords;\\;;>;1;;;;;",
                        ';',
                        fileMonitor,
                        metaData);
        assertEquals(expected, parsed);
    ...
    void fromStringThrowsParseExceptionForNotEscapedGroupName() throws Exception {
        assertThrows(
                ...
                () ->
                        GroupsParser.fromString(
                                "ExplicitGroup:slit\\\\;0\\;mertsch_slit2_2007\\;;",
                                ',',
                                fileMonitor,
                                metaData));
    }
    ...
    void importSubGroups() throws Exception {
        ...
        GroupTreeNode parsedNode =
                GroupsParser.importGroups(orderedData, ',', fileMonitor, metaData);
    ...
    void fromStringParsesExplicitGroupWithIconAndDescription() throws Exception {
        ExplicitGroup expected =
                new ExplicitGroup("myExplicitGroup", GroupHierarchyType.INDEPENDENT, ',');
        ...
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "StaticGroup:myExplicitGroup;0;1;0xf0f8ffff;test icon;test description;",
                        ',',
                        fileMonitor,
                        metaData);
    ...
    void fromStringParsesAutomaticKeywordGroup() throws Exception {
        ...
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "AutomaticKeywordGroup:myAutomaticGroup;0;keywords;,;>;1;;;;",
                        ',',
                        fileMonitor,
                        metaData);
        assertEquals(expected, parsed);
    ...
    void fromStringParsesAutomaticPersonGroup() throws Exception {
        AutomaticPersonsGroup expected =
                new AutomaticPersonsGroup(
                        "myAutomaticGroup", GroupHierarchyType.INDEPENDENT, StandardField.AUTHOR);
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "AutomaticPersonsGroup:myAutomaticGroup;0;author;1;;;;",
                        ',',
                        fileMonitor,
                        metaData);
        assertEquals(expected, parsed);
    ...
    void fromStringParsesTexGroup() throws Exception {
        ...
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "TexGroup:myTexGroup;0;path/To/File;1;;;;", ',', fileMonitor, metaData);
        assertEquals(expected, parsed);
    }
    ...
    void fromStringUnknownGroupThrowsException() throws Exception {
        assertThrows(
                ...
                () ->
                        GroupsParser.fromString(
                                "0 UnknownGroup:myUnknownGroup;0;;1;;;;",
                                ',',
                                fileMonitor,
                                metaData));
    }
    ...
    void fromStringParsesSearchGroup() throws Exception {
        SearchGroup expected =
                new SearchGroup(
                        "Data",
                        GroupHierarchyType.INCLUDING,
                        "project=data|number|quant*",
                        EnumSet.of(SearchFlags.REGULAR_EXPRESSION));
        AbstractGroup parsed =
                GroupsParser.fromString(
                        "SearchGroup:Data;2;project=data|number|quant*;0;1;1;;;;;",
                        ',',
                        fileMonitor,
                        metaData);
        assertEquals(expected, parsed);
