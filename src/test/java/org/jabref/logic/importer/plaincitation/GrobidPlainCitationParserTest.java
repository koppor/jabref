...
public class GrobidPlainCitationParserTest {
    ...
    static GrobidPreferences grobidPreferences =
            new GrobidPreferences(true, false, "http://grobid.jabref.org:8070");
    static GrobidPlainCitationParser grobidPlainCitationParser =
    ...
    static BibEntry example3AsBibEntry =
            new BibEntry(StandardEntryType.InBook)
                    .withCitationKey("-1")
                    .withField(
                            StandardField.AUTHOR,
    ...
    void grobidPerformSearchCorrectResultTest(
            String testName, BibEntry expectedBibEntry, String searchQuery)
    ...
    void grobidPerformSearchWithInvalidDataTest(String invalidInput) throws FetcherException {
        assertThrows(
                ...
                () -> grobidPlainCitationParser.parsePlainCitation("invalidInput"),
                "performSearch should throw an FetcherException.");
    }
    ...
    void performSearchThrowsExceptionInCaseOfConnectionIssues() throws IOException, ParseException {
        ...
        grobidPlainCitationParser =
                new GrobidPlainCitationParser(importFormatPreferences, grobidServiceMock);

        assertThrows(
                FetcherException.class,
                () -> grobidPlainCitationParser.parsePlainCitation("any text"),
