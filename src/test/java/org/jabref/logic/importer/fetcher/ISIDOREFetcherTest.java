...
class ISIDOREFetcherTest {
    ...
    void checkArticle1() throws FetcherException {
        BibEntry expected =
                new BibEntry(StandardEntryType.Article)
                        ...
                        .withField(
                                StandardField.URL,
                                "https://isidore.science/document/10670/1.hrzlqd");

        List<BibEntry> actual =
    ...
    void checkArticle2() throws FetcherException {
        BibEntry expected =
                new BibEntry(StandardEntryType.Article)
                        .withField(
                                StandardField.TITLE,
                                "Inequality – What Can Be Done ? Cambridge (Mass.) Harvard University Press, 2015, XI-384 p. ")
                        .withField(StandardField.AUTHOR, "Benoît Rapoport")
                        .withField(StandardField.YEAR, "2016")
                        .withField(StandardField.JOURNAL, "Population (édition française)")
                        .withField(
                                StandardField.PUBLISHER,
                                "HAL CCSD, INED - Institut national d’études démographiques")
                        .withField(StandardField.DOI, "10.3917/popu.1601.0153")
                        .withField(
                                StandardField.URL,
                                "https://isidore.science/document/10670/1.d2vlam");
    ...
    void checkThesis() throws FetcherException {
        BibEntry expected =
                new BibEntry(StandardEntryType.Thesis)
                        .withField(
                                StandardField.TITLE,
        ...
        // The results obtained by the fetcher contain three entries (as of 2024), and the first
        // matches our expected entry. So, we can use actual.getFirst(), but shall still use
        // findFirst() in case the order of returned items changes.
        Optional<BibEntry> matchingEntry =
                actual.stream().filter(entry -> entry.equals(expected)).findFirst();
        ...
        BibEntry expected =
                new BibEntry(StandardEntryType.Article)
                        ...
                        .withField(
                                ...
                                "G. Ploussard and G. Gandaglia and H. Borgmann and P. de Visschere and I. Heidegger and A. Kretschmer and R. Mathieu and C. Surcel and D. Tilki and I. Tsaur and M. Valerio and R. van den Bergh and P. Ost and A. Briganti")
                        .withField(StandardField.YEAR, "2019")
                        .withField(StandardField.JOURNAL, "European urology")
                        .withField(StandardField.DOI, "10.1016/j.eururo.2018.10.041")
                        .withField(
                                StandardField.URL,
                                "https://isidore.science/document/10670/1.zm7q2x");
        ...
        assertEquals(
                List.of(
                        new BibEntry(StandardEntryType.Article)
                                .withField(
                                        StandardField.AUTHOR,
                                        "Howard Green and Karen Boyland and Adam Strange")
                                .withField(StandardField.DOI, "doi:10.3406/htn.1990.2970")
                                .withField(
                                        StandardField.TITLE,
                                        "Le rôle des pépinières dans le développement des entreprises accueillies : essai d'évaluation. L'exemple du Yorkshire -Humberside (R.U.)")
