    ...
    void setUp() throws InterruptedException {
        ...
        entryEndharti =
                new BibEntry(StandardEntryType.Article)
                        ...
                        .withField(
                                StandardField.AUTHOR,
                                "Endharti, Agustina Tri and Wulandari, Adisti and Listyana, Anik and Norahmawati, Eviana and Permana, Sofy")
                        .withField(new UnknownField("country"), "England")
                        ...
                        .withField(
                                StandardField.JOURNAL, "BMC complementary and alternative medicine")
                        .withField(
                                StandardField.KEYWORDS,
                                "CAC; Dendrophtoe pentandra; IL-22; MPO; Proliferation; p53")
        ...
        bibEntryIchikawa =
                new BibEntry(StandardEntryType.Article)
                        .withField(
                                StandardField.AUTHOR,
                                "Ichikawa-Seki, Madoka and Guswanto, Azirwan and Allamanda, Puttik and Mariamah, Euis Siti and Wibowo, Putut Eko and Igarashi, Ikuo and Nishikawa, Yoshifumi")
                        .withField(
                                new UnknownField("chemicals"),
                                "Antibodies, Protozoan, Antigens, Protozoan, GRA7 protein, Toxoplasma gondii, Protozoan Proteins")
        ...
        bibEntrySari =
                new BibEntry(StandardEntryType.Article)
                        .withField(
                                StandardField.AUTHOR,
                                "Sari, Yulia and Haryati, Sri and Raharjo, Irvan and Prasetyo, Afiono Agung")
                        .withField(
                                new UnknownField("chemicals"),
                                "Antibodies, Protozoan, Antibodies, Viral, HTLV-I Antibodies, HTLV-II Antibodies, Hepatitis Antibodies, Hepatitis B Antibodies, Hepatitis C Antibodies, Immunoglobulin G, Immunoglobulin M")
                        .withField(new UnknownField("citation-subset"), "IM")
        ...
        assertThrows(
                ...
                () ->
                        fetcher.performSearchById(
                                "this.is.a.invalid.search.term.for.the.medline.fetcher"));
    }
