...
class INSPIREFetcherTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        BibEntry master =
                new BibEntry(StandardEntryType.MastersThesis)
    ...
    void searchByIdentifierFindsEntry() throws Exception {
        BibEntry article =
                new BibEntry(StandardEntryType.Article)
                        ...
                        .withField(
                                StandardField.AUTHOR, "Melnikov, Kirill and Yelkhovsky, Alexander")
                        .withField(
                                StandardField.TITLE,
                        ...
                        .withField(StandardField.ARCHIVEPREFIX, "arXiv")
                        .withField(
                                new UnknownField("reportnumber"), "BUDKER-INP-1998-7, TTP-98-10");
