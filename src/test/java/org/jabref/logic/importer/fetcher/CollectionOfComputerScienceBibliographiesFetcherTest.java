...
class CollectionOfComputerScienceBibliographiesFetcherTest {
    ...
    @Test
    void getUrlForQueryReturnsCorrectUrl()
    ...
    void performSearchReturnsMatchingMultipleEntries() throws FetcherException {
        ...
        BibEntry secondBibEntry =
                new BibEntry(StandardEntryType.Article)
                        ...
                        .withField(
                                new UnknownField("subject"),
                                "Software Architecture; Code Churn; Open Source; Architecrual Erosion; Technical Debt; Software Engineering; Programvaruteknik")
                        .withField(
                                new UnknownField("relation"),
                                "ACM International Conference Proceeding Series; ECSA '17~Proceedings of the 11th European Conference on Software Architecture : Companion Proceedings, p. 152-158")
                        .withField(
                        ...
                        .withField(
                                new UnknownField("description"), "Information and Software Qualtiy")
        ...
        // Checking a subset, because the query "jabref" is generic and returns a changing result
        // set
        assertEquals(
                Set.of(secondBibEntry),
                searchResult.stream()
                        .filter(
                                bibEntry -> {
