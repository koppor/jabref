...
class IEEETest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    private static final BibEntry IGOR_NEWCOMERS =
    ...
    void findByDOI() throws Exception {
        ...
        assertEquals(
                Optional.of(
                        URI.create(
                                        "https://ieeexplore.ieee.org/ielx7/6287639/7419931/07421926.pdf?tp=&arnumber=7421926&isnumber=7419931&ref=")
                                .toURL()),
    ...
    void findByDocumentUrl() throws Exception {
        BibEntry entry =
                new BibEntry()
                        .withField(
                                StandardField.URL, "https://ieeexplore.ieee.org/document/7421926/");
        assertEquals(
                Optional.of(
                        URI.create(
                                        "https://ieeexplore.ieee.org/ielx7/6287639/7419931/07421926.pdf?tp=&arnumber=7421926&isnumber=7419931&ref=")
    ...
    void findByURL() throws Exception {
        BibEntry entry =
                new BibEntry()
                        .withField(
                                StandardField.URL,
                                "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7421926&ref=");
        assertEquals(
                Optional.of(
                        URI.create(
                                        "https://ieeexplore.ieee.org/ielx7/6287639/7419931/07421926.pdf?tp=&arnumber=7421926&isnumber=7419931&ref=")
    ...
    void findByOldURL() throws Exception {
        BibEntry entry =
                new BibEntry()
                        .withField(
                                StandardField.URL,
                                "https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=7421926");
        assertEquals(
                Optional.of(
                        URI.create(
                                        "https://ieeexplore.ieee.org/ielx7/6287639/7419931/07421926.pdf?tp=&arnumber=7421926&isnumber=7419931&ref=")
    ...
    void findByDOIButNotURL() throws Exception {
        BibEntry entry =
                new BibEntry()
                        ...
                        .withField(
                                StandardField.URL, "http://dx.doi.org/10.1109/ACCESS.2016.2535486");
        assertEquals(
                Optional.of(
                        URI.create(
                                        "https://ieeexplore.ieee.org/ielx7/6287639/7419931/07421926.pdf?tp=&arnumber=7421926&isnumber=7419931&ref=")
