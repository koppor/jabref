...
class DBLPFetcherTest {
    ...
    void setUp() {
        ...
        entry.setField(
                new UnknownField("biburl"), "https://dblp.org/rec/journals/stt/GeigerHL16.bib");
        entry.setField(
    ...
    void findSingleEntry() throws FetcherException {
        // In Lucene curly brackets are used for range queries, therefore they have to be escaped
        // using "". See
    ...
    void findSingleEntryUsingComplexOperators() throws FetcherException {
        String query =
                "geiger harrer betsy$ softw.trends"; // -wirtz Negative operators do no longer work,
        //  see issue
