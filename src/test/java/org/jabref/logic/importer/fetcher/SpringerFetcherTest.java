...
class SpringerFetcherTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        ...
        BibEntry secondArticle =
                new BibEntry(StandardEntryType.Article)
                        ...
                        .withField(
                                StandardField.JOURNAL, "Computer Supported Cooperative Work (CSCW)")
    ...
    void supportsPhraseSearch() throws Exception {
        // Normal search should match due to Redmiles, Elissa M., phrase search on the other hand
        // should not find it.
        BibEntry expected =
                new BibEntry(StandardEntryType.InCollection)
                        .withField(
    ...
    void supportsBooleanANDSearch() throws Exception {
        ...
        List<BibEntry> allEntriesFromCSCW =
                result.stream()
                        .filter(
                                bibEntry ->
