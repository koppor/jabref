...
class SpringerFetcherTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        ...
        assertEquals(
                List.of(articleTagThatIssue, fourthArticle, thirdArticle, firstArticle, secondArticle), fetchedEntries);
    }
    ...
    public void supportsBooleanANDSearch() throws Exception {
        ...
        List<BibEntry> result =
                fetcher.performSearch("author:\"Redmiles, David\" AND journal:\"Computer Supported Cooperative Work\"");
        ...
        List<BibEntry> allEntriesFromCSCW = result.stream()
                .filter(bibEntry -> "Computer Supported Cooperative Work (CSCW)"
                        .equals(bibEntry.getField(StandardField.JOURNAL).orElse("")))
                .toList();
