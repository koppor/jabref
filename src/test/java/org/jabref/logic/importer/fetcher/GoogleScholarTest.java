...
class GoogleScholarTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void findSingleEntry() throws FetcherException {
        ...
        entry.setField(
                StandardField.TITLE, "Detecting Interoperability and Correctness Issues in BPMN 2.0 Process Models.");
        ...
        List<BibEntry> foundEntries =
                finder.performSearch("Detecting Interoperability and Correctness Issues in BPMN 2.0 Process Models");
