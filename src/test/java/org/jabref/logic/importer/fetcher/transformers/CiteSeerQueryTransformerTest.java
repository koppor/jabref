...
class CiteSeerQueryTransformerTest extends InfixTransformerTest<CiteSeerQueryTransformer> {
    ...
    void convertSortByField() throws Exception {
        ...
        Optional<String> sortBy =
                Optional.of(transformer.getJSONPayload().get("sortBy").toString());
    ...
    private static Stream<Arguments> getJSONWithYearVariations() throws FetcherException {
        ...
        List<String> withYearAndYearRange =
                List.of(
                        StringUtil.join(new String[] {baseString, "year:2020"}, " ", 0, 2),
                        StringUtil.join(
                                new String[] {baseString, "year-range:2019-2023"}, " ", 0, 2));
    ...
    void compareJSONRequestsWithYearVariations(
            JSONObject expected, Integer yearStart, Integer yearEnd, JSONObject actual)
            throws Exception {
