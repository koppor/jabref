...
public class JstorFetcherTest implements SearchBasedFetcherCapabilityTest {
    ...
    private final JstorFetcher fetcher =
            new JstorFetcher(mock(ImportFormatPreferences.class, Answers.RETURNS_DEEP_STUBS));
    ...
    private final BibEntry doiEntry =
            new BibEntry(StandardEntryType.Article)
    ...
    void searchByTitle() throws Exception {
        List<BibEntry> entries =
                fetcher.performSearch(
                        "title: \"Test Anxiety Analysis of Chinese College Students in Computer-based Spoken English Test\"");
    ...
    void searchByUrlUsingId() throws Exception {
        doiEntry.setField(
                StandardField.URLDATE, LocalDate.now().format(DateTimeFormatter.ISO_DATE));
        assertEquals(
    ...
    void fetchPDF() throws Exception {
        ...
        assertEquals(
                Optional.of(URI.create("https://www.jstor.org/stable/pdf/90002164.pdf").toURL()),
                url);
    }
