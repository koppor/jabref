        ...
        return Stream.of(
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URI, "https://directory.doabooks.org/handle/20.500.12854/34739")
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URI, "https://directory.doabooks.org/handle/20.500.12854/26303")
                                .withField(StandardField.LANGUAGE, "English")
                                .withField(
                                        StandardField.KEYWORDS,
                                        "Open Access, Monographs, OAPEN Library, " + "Directory of Open Access Books")
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.TITLE, "Four Kingdom Motifs before and beyond the Book of Daniel")
                                ...
                                .withField(
                                        StandardField.URI, "https://directory.doabooks.org/handle/20.500.12854/68086")
                                .withField(StandardField.LANGUAGE, "English")
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URI, "https://directory.doabooks.org/handle/20.500.12854/39793")
                                .withField(StandardField.LANGUAGE, "English")
                                .withField(
                                        StandardField.KEYWORDS,
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URI, "https://directory.doabooks.org/handle/20.500.12854/38792")
                                .withField(StandardField.LANGUAGE, "English")
                                .withField(
                                        StandardField.KEYWORDS,
