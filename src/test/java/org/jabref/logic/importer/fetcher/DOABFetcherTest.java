...
public class DOABFetcherTest {
        ...
        return Stream.of(
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URL,
                                        "http://library.oapen.org/handle/20.500.12657/25535")
                                .withField(
                                        StandardField.URI,
                                        "https://directory.doabooks.org/handle/20.500.12854/34739")
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.TITLE, "The deliverance of open access books")
                                .withField(
                                        StandardField.SUBTITLE, "Examining usage and dissemination")
                                ...
                                .withField(
                                        StandardField.URI,
                                        "https://directory.doabooks.org/handle/20.500.12854/26303")
                                .withField(StandardField.LANGUAGE, "English")
                                .withField(
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URL,
                                        "https://library.oapen.org/handle/20.500.12657/48312")
                                .withField(
                                        StandardField.URI,
                                        "https://directory.doabooks.org/handle/20.500.12854/68086")
                                .withField(StandardField.LANGUAGE, "English")
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                ...
                                .withField(
                                        StandardField.URI,
                                        "https://directory.doabooks.org/handle/20.500.12854/39793")
                                .withField(StandardField.LANGUAGE, "English")
                                .withField(
                                        StandardField.KEYWORDS,
                                        "UAV sensors, Environmental Monitoring, drones, unmanned aerial vehicles")
                                .withField(
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                                .withField(
                                        ...
                                        "Carl Marnewick and Wikus Erasmus and Joseph Nazeer")
                                .withField(
                                        StandardField.TITLE,
                                ...
                                .withField(
                                        StandardField.URL,
                                        "http://library.oapen.org/handle/20.500.12657/30652")
                                .withField(
                                        StandardField.URI,
                                        "https://directory.doabooks.org/handle/20.500.12854/38792")
                                .withField(StandardField.LANGUAGE, "English")
                                .withField(
                                        StandardField.KEYWORDS,
                                        "agile, structural equation modelling, information technology, success, models, strategic alignment, complexity, waterfall, project management, quantitative, Agile software development, Change management, Deliverable, Exploratory factor analysis, South Africa, thema EDItEUR::U Computing and Information Technology::UB Information technology: general topics")
    ...
    void performSearch(BibEntry expected, String query) throws FetcherException {
        ...
        // We must not contain abstracts in our code base; thus we remove the abstracts from the
        // fetched results
