...
class RfcFetcherTest {
    ...
    private RfcFetcher fetcher =
            new RfcFetcher(mock(ImportFormatPreferences.class, Answers.RETURNS_DEEP_STUBS));
    ...
    void performSearchByIdFindsEntryWithDraftIdentifier() throws Exception {
        BibEntry bibDraftEntry =
                new BibEntry(StandardEntryType.TechReport)
                        ...
                        .withField(
                                StandardField.URL,
                                "https://datatracker.ietf.org/doc/draft-fielding-http-spec/01/")
        ...
        bibDraftEntry.setCommentsBeforeEntry(
                "%% You should probably cite draft-ietf-http-v10-spec instead of this I-D.\n");

        assertEquals(
                Optional.of(bibDraftEntry), fetcher.performSearchById("draft-fielding-http-spec"));
    }
